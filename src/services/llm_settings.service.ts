...
export const AGENTES_LLM: Array<{ name: string; titulo: string; descripcion: string; defaultModel: string }> = [
  ...
  { name: 'agent_builder',      titulo: 'Programador de agentes', descripcion: 'Crea agentes personalizados con herramientas en JS. Necesita el mejor modelo disponible para programar bien.', defaultModel: 'gemini-3.8-flash' },
